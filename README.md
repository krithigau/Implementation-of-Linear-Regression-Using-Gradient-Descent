...
5. Plot the Cost function using Gradient Descentand generate the required graph.
6. End the program.
...
## Output:
![image](https://github.com/user-attachments/assets/be640cad-a3bc-4991-96e9-e641b63ad269)
